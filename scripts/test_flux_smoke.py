"""
Smoke test Flux: verifica che i 4 pattern producano output sensati
prima di lanciare il batch completo.
NB: Flux non supporta negative_prompt (guidance-distilled).
"""
import os
import sys
import time
